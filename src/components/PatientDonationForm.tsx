      ...
      {submitted && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white text-gray-900 rounded-[2rem] p-8 shadow-2xl max-w-sm w-full text-center relative">
            ...
            <h2 className="text-xl font-black text-[#111111] mb-2 uppercase tracking-tighter">Thank You!</h2>
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h3 className="text-sm font-bold uppercase tracking-widest text-[#111111]">Spread the Hope</h3>
            </div>
